...
<script type="text/javascript">
	function change() {
		...
		img.src = "${pageContext.request.contextPath}/admin/checkCode?"
				+ new Date;
	}
</script>
<style>
		...
		<div class="col-md-8 col-md-offset-2"
			...
			<form action="${pageContext.request.contextPath}/admin/login"
						...
						<div class="row">
							<div class="col-md-5">
								<img name="checkCodeImg" id="checkCodeImg"
									src="${pageContext.request.contextPath}/admin/checkCode"
				...
				<div class="form-group">
					<div class=" col-md-5">
						<button type="submit"
							class="btn btn-info col-md-10 col-md-offset-1"
							style="margin-top: 30px;">登录</button>
					</div>
				</div>
			</form>
		</div>
