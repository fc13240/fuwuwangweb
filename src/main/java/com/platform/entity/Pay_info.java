...
public class Pay_info {
	...
	public Pay_info(Integer longbi_number, Double dianzibi_number, String chrCode, String respMsg, String reserve,
			Integer respCode, String merOrderId, String transId, String results) {
		super();
	...
	public String toString() {
		return "Pay_info [longbi_number=" + longbi_number + ", dianzibi_number=" + dianzibi_number + ", ChrCode="
				+ ChrCode + ", RespMsg=" + RespMsg + ", Reserve=" + Reserve + ", RespCode=" + RespCode + ", MerOrderId="
				+ MerOrderId + ", TransId=" + TransId + ", results=" + results + "]";
	}
}
