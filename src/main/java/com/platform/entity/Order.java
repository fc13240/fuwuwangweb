...
public class Order {
	...
	public Order(String order_id, String user_id, String goods_id,
			Integer gooods_number, Integer goods_price, Integer return_number,
			Integer order_state, Integer pay_type, Integer lB_money,
			Integer electronics_money, Integer unionpay_money,
			String electronics_evidence, String chrCode, String transId,
			Date order_time, Date pay_time, Date deal_time) {
		super();
	...
	public String toString() {
		return "Order [order_id=" + order_id + ", user_id=" + user_id
				+ ", goods_id=" + goods_id + ", gooods_number=" + gooods_number
				+ ", goods_price=" + goods_price + ", return_number="
				+ return_number + ", order_state=" + order_state
				+ ", pay_type=" + pay_type + ", LB_money=" + LB_money
				+ ", electronics_money=" + electronics_money
				+ ", Unionpay_money=" + Unionpay_money
				+ ", electronics_evidence=" + electronics_evidence
				+ ", chrCode=" + chrCode + ", tranId=" + transId
