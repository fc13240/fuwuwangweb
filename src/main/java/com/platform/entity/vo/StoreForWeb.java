...
public class StoreForWeb {
	...
	public StoreForWeb(String store_id, String store_name, String store_desc,
	...
	public String toString() {
		return "StoreForWeb [store_id=" + store_id + ", store_name=" + store_name + ", store_desc=" + store_desc
				+ ", store_img=" + store_img + ", user_id=" + user_id + ", store_state=" + store_state
				+ ", store_create_time=" + store_create_time + ", store_check_time=" + store_check_time
				+ ", check_user_id=" + check_user_id + ", street_id=" + street_id + ", store_phone=" + store_phone
				+ ", store_type2_id=" + store_type2_id + ", store_address=" + store_address + ", userLogin=" + userLogin
				+ "]";
	}
