...
<%@ include file="../../common/checkmenu.jsp"%>
<style>
.table th {
	text-align: center;
}
	...
	function getGoodsByGoods_state() {
		...
		if (goods_state == 4) {
			...
			window.location.href = base
					+ '/checkadmin/goods/goodslistbyGoods_state?goods_state=' + goods_state;
		}
	}
</script>
...
<div class="wrapper">
	...
	<form class="searchform"
		action="${pageContext.request.contextPath}/checkadmin/goods/searchbygoods_name"
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<form class="form-horizontal col-sm-offset-2"
				action="${pageContext.request.contextPath}/checkadmin/goods/checkgoods_pass"
...
<div class="modal fade" id="failModal" tabindex="-1" role="dialog"
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<form class="form-horizontal col-sm-offset-2"
				action="${pageContext.request.contextPath}/checkadmin/goods/checkgoods_fail"
				method="post" enctype="multipart/form-data">
...
<script>
	function modifyEmp1(goods_id, type) {
		...
		var base = "${pageContext.request.contextPath}";
		$.ajax({
					url : base + "/checkadmin/goods/goodsinfo",
					type : "GET",
					datatype : "text",
					...
					success : function(data) {
						...
						if (0 == data1.goods_delete_state
							...
							if (judge) {
								...
								$("#info_footer")
										.append(
												"<form class=\"form-horizontal col-sm-offset-2\" action=\"${pageContext.request.contextPath}/checkadmin/goods/deletegoods_recommend\" method=\"post\" enctype=\"multipart/form-data\">"
								...
								$("#info_footer")
										.append(
												"<form class=\"form-horizontal col-sm-offset-2\" action=\"${pageContext.request.contextPath}/checkadmin/goods/addgoods_recommend\" method=\"post\" enctype=\"multipart/form-data\">"
														+ "<input type=\"hidden\"  name=\"goods_id\" id=\"g_id1\"/>"
