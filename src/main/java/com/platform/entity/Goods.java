...
public class Goods{
	...
	public Goods(){
 	...
 	public Goods(String goods_id, String goods_name, String goods_desc, String goods_img
			...
			,Date goods_check_time,String goods_check_user,String goods_purchase_notes){
