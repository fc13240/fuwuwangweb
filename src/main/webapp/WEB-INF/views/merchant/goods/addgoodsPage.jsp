...
function getPhoto(){
	...
	function check() { /* passWord newpass */
		...
		if (txt_goods_desc.length == 0||txt_goods_desc.length>200) {
		...
		if (txt_goods_purchase_notes.length == 0||txt_goods_purchase_notes.length>200) {
			$("#goods_purchase_notesLabel").text("购买须知不符合规范！")
