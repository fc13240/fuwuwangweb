...
public class GoodsVo{
	...
	public GoodsVo(){
 	...
 	public GoodsVo(String goods_id, String goods_name, String goods_desc, String goods_img
	...
	public String toString() {
		return "GoodsVo [goods_id=" + goods_id + ", goods_name=" + goods_name + ", goods_desc=" + goods_desc
