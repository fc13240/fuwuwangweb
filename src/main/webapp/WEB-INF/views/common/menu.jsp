	...
	<div class="left-side-inner">
		<ul class="nav nav-pills nav-stacked custom-nav">
			<li class="menu-list"><a href="#"><i class="fa fa-user"></i>
				...
				<ul class="sub-menu-list">
					<li><a
						href="${pageContext.request.contextPath}/admin/store/list">店铺列表</a></li>
					<li><a
		...
		<ul class="nav nav-pills nav-stacked custom-nav">
			<li class="menu-list"><a
				...
				<ul class="sub-menu-list">
					<li><a
						href="${pageContext.request.contextPath}/admin/goods/list">商品列表</a></li>
					<li><a
						href="${pageContext.request.contextPath}/admin/goods/findAllGoodsrecommend">推荐商品</a></li>
					<li><a
						href="${pageContext.request.contextPath}/admin/financial/goodsdefault">商品销售</a></li>
				</ul></li>
		</ul>
		<ul class="nav nav-pills nav-stacked custom-nav">
			<li class="menu-list"><a href="#"><i class="fa fa-user"></i>
				...
				<ul class="sub-menu-list">
					<li><a
						href="${pageContext.request.contextPath}/admin/ad/adlist_activity">广告列表</a></li>
					<li><a
						href="${pageContext.request.contextPath}/admin/ad/execute">广告添加</a></li>
					<li><a
						href="${pageContext.request.contextPath}/admin/ad/adlist_del">历史广告</a></li>
				</ul></li>
		</ul>
		<ul class="nav nav-pills nav-stacked custom-nav">
			<li class="menu-list"><a href="#"><i class="fa fa-user"></i>
				...
				<ul class="sub-menu-list">
					...
					<li><a
						href="${pageContext.request.contextPath}/admin/user/merchant/mlist">商人列表</a></li>
					<li><a
		...
		<ul class="nav nav-pills nav-stacked custom-nav">
			<li class="menu-list"><a href="#"><i class="fa fa-user"></i>
				...
				<ul class="sub-menu-list">
					<li><a
						href="${pageContext.request.contextPath}/admin/financial/userdefault">个人消费查询</a></li>
					<li><a
						href="${pageContext.request.contextPath}/admin/financial/storedefault">店铺消费查询</a></li>
				</ul></li>
		</ul>
