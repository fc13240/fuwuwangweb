...
public class GoodsForWeb{
	...
	public GoodsForWeb(){
 	...
 	public GoodsForWeb(String goods_id, String goods_name, String goods_desc, String goods_img
			...
			String store_name,Integer goods_putaway_state,String goods_return_mz){
	...
	public String toString() {
		return "GoodsForWeb [goods_id=" + goods_id + ", goods_name=" + goods_name + ", goods_desc=" + goods_desc
				...
				+ ", store_name=" + store_name + ", goods_putaway_state=" + goods_putaway_state + "]";
	}
